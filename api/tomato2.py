...
MODEL = tf.keras.models.load_model(r"C:\Users\USER\Downloads\diseasedetection\models\8\tomato.h5")

CLASS_NAMES = ["Tomato_Early_blight", "Tomato_Late_blight", "Tomato_Leaf_Mold","Tomato_Septoria_leaf_spot","Tomato_Late_blight","Tomato__Tomato_YellowLeaf__Curl_Virus","Tomato__Tomato_mosaic_virus","Tomato_healthy","tomato_verticulium wilt"]
